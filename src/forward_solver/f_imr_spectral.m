    ...
    function dXdt = SVBDODE(t,X)
        ...
        if bubtherm
            ...
            if medtherm
                ...
                % stress dissipation
                if graded
                    [taugradu] = f_stress_dissipation_graded(stress,spectral,Req,R,Rdot,...
                        Ca,Ca1,Br,Re8,yT,yT3,iyT3,iyT6,X,ZZT,ivisco1,ivisco2,fnu,DRe, ...
                        l1,l2,v_a,v_nc);
                else
        ...
        if graded
            [S,Sdot,Z1dot,Z2dot] = f_stress_graded(radial,stress,Req,...
                R,Ca,Ca1,Re8,Rdot,alphax,intfnu,dintfnu,iDRe,l1,l2,v_a,v_nc,yT3,gfun);
        else
