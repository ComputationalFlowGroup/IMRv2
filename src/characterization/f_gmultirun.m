...
function [data,Rdata] = f_gmultirun(n,R_min,R_max,Lambda_min,Lambda_max,G0,G1,l1,l2,v_a,v_nc)
% EXAMPLE FUNCTION CALL: f_gmultirun(1,100E-6,400E-6,4,10,1E3,10E3,1.2e-4,1.8e-4,2,0.3)
