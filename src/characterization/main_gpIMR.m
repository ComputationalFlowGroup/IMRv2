...
infile2 = 'Rdata.mat'; % WHY DOES THIS RESULT IN 1X1 CELL, THOUGH IN IMR/SRC/CHARACT IT'S NX1??
load(infile2);
...
l1_min = Req_max;
l1_start = 1.2E-4; %2*Req_max;
l1_max = l1_start + 1e-6; %8*Req_max;

% l2 must be greater than l1
l2_min = l1_start + 1e-6; 
l2_max = 5*Req_max; %10*Req_max; 
l2_start = 1.8e-4; %3*Req_max;
