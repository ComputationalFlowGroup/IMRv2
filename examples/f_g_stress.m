...
elseif r_eval <= l2
    % near field
     ...
     r0near(r0near > l1) = 0;
     taurr1 = (2/(3*Ca))*((r0near.^4 ./ r_subset.^4) - (r_subset.^2 ./ r0near.^2));
     % zero out the stress above and below the near field
     taurr1(isinf(taurr1)) = 0;

     % compute the graded region coordinate
     r0mid = r0coord(r0coord > l1 & r0coord <= l2);
     % graded stress
     taurr2 = ((1/Ca) + (1/Ca1 - 1/Ca)*(1+f_cy(r0mid).^v_a).^((v_nc-1)/v_a)).* ...
            ((r0mid.^4 ./ r_subset.^4) - (r_subset.^2 ./ r0mid.^2));
...
elseif r_eval > l2
    ...
    r0far(r0far < l2) = 0;
    taurr3 = (2/(3*Ca1))*((r0far.^4 ./ r_subset.^4) - (r_subset.^2 ./ r0far.^2));
