...
function [taurr] = f_g_stress(r_eval,rcoord,R,Req,Ca,Ca1,l1,l2,v_nc,v_a)
...
elseif r_eval > l2
    ...
    taurr(far_mask) = taurr3;
end

% removing any infs or nans
taurr(isnan(taurr) | isinf(taurr)) = 0;

taurr = interp1(r_subset, taurr, r_eval, 'pchip');
end
