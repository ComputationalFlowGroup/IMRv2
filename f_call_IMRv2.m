function [t, R, epnm] = f_call_IMRv2(Rmax, Req, epnm0, epnmd0, modes, mu, G, alph, sig, p_a, f_a, tf_nd, tsteps, ultra)
...
varin = {'progdisplay',0,'radial',radial,'bubtherm',bubtherm,'tvector',tvector,...
    ...
    'modes', modes,'epnm0', epnm0, 'pertmod', pertmod, ...
    'epnmd0', epnmd0, 'reltol', 1e-4, 'abstol', 1e-6, 'Nt', 75};
